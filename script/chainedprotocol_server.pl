...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{CHAINEDPROTOCOL_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{CHAINEDPROTOCOL_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
chainedprotocol_server.pl - Catalyst Testserver

=head1 SYNOPSIS

chainedprotocol_server.pl [options]
